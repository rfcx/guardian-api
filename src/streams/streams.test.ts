...
beforeAll(async () => {
  ...
  setupMockAxios('noncore', GET, `v2/streams/${STREAM1}`, 200, { type: 'satellite' })
  setupMockAxios('noncore', GET, `v2/streams/${STREAM2}`, 200, { type: 'gsm' })
  setupMockAxios('noncore', GET, `v2/streams/${STREAM3}`, 404, undefined)
  setupMockAxios('noncore', GET, `v2/streams/${STREAM4}`, 200, { type: 'edge' })
  setupMockAxios('noncore', GET, `v2/streams/${STREAM5}`, 404, undefined)
})
beforeEach(async () => {
